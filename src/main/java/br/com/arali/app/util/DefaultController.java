...
public abstract class DefaultController {
    ...
    public abstract Object delete(Request req, Response res, Long id);
    ...
    public void load(){
        ...
        spark.Spark.delete(resource  + "/:id", (req, res) -> {
            return delete(req, res, Long.parseLong(req.params("id")));
        });
